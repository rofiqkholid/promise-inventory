@extends('layouts.app')
@section('title', 'Regular VAVE Dashboard')
@section('page_title', 'VA/VE Analysis Dashboard (Regular)')
@section('header-title', 'Regular VAVE Dashboard')
        ...
        <div class="table-container bg-white dark:bg-gray-800 p-3 lg:p-4 rounded-xs border border-gray-200 dark:border-gray-700 flex flex-col relative flex-1 min-h-0">
            <div class="flex-none flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 mb-2.5">
                <h3 class="text-xs sm:text-sm font-semibold text-gray-800 dark:text-gray-100 flex items-center min-w-0">
                    ...
                    <span class="truncate">Detailed VAVE Analysis (Regular Model)</span>
                </h3>
...
$(function() {
    ...
    function refreshData() {
        ...
        // UPDATED: Point to regularVaveDashboard routes
        $.get('{{ route("inventory.regularVaveDashboard.chartData") }}', params, function(res) {
            updateKPIs(res.kpi);
    ...
    function refreshParetoData() {
        ...
        $.get('{{ route("inventory.regularVaveDashboard.paretoData") }}', params, function(res) {
