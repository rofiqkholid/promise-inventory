...
<div class="p-4 sm:p-6 lg:p-8 text-gray-900 dark:text-gray-100">
    ...
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100 sm:text-3xl tracking-tighter">Transaction Category</h2>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400 font-medium">Manage inventory flow categories and effects.</p>
        </div>
        <div class="mt-4 sm:mt-0">
            <button type="button" class="add-button inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-slate-900 hover:bg-slate-800 border border-transparent rounded-md text-[10px] font-bold text-white uppercase tracking-widest shadow-md active:scale-[0.98] transition-all" data-target="transaction-category">
    ...
    <x-table id="transactionCategoryTable">
        <thead class="bg-gray-50 dark:bg-gray-700">
            <tr>
                ...
                <th scope="col" class="px-6 py-3 text-center text-[10px] font-bold uppercase tracking-wider text-gray-600 dark:text-gray-400">Effect</th>
...
<div id="modal-transaction-category-add" class="modal-container hidden">
    <div class="relative p-4 w-full max-w-md">
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <h3 class="mb-4 text-xl text-center font-bold text-slate-900 dark:text-white uppercase tracking-tight">Add Category</h3>
            <form class="modal-form" data-action="{{ route('inventory.master.transactionCategory.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="code" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-sm" placeholder="e.g. IN-PO">
...
<div id="modal-transaction-category-edit" class="modal-container hidden">
    <div class="relative p-4 w-full max-w-md">
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <h3 class="mb-4 text-xl text-center font-bold text-slate-900 dark:text-white uppercase tracking-tight">Edit Category</h3>
        ...
        window.masterTable = window.defaultDataTable('#transactionCategoryTable', {
            ...
            columns: [
                ...
                { data: 'name' },
                {
                    ...
                    render: (d) => {
                        if (d == 1) return '<span class="px-2 py-1 text-[9px] font-bold bg-green-100 text-green-700 rounded-full">IN (+)</span>';
                        if (d == -1) return '<span class="px-2 py-1 text-[9px] font-bold bg-red-100 text-red-700 rounded-full">OUT (-)</span>';
                        return '<span class="px-2 py-1 text-[9px] font-bold bg-gray-100 text-gray-700 rounded-full">ADJ (0)</span>';
                    }
                },
                {
