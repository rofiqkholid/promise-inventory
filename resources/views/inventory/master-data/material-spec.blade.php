        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form class="modal-form" data-action="{{ route('inventory.master.materialSpec.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="spec_name" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-sm" placeholder="e.g. SPHC">
                    <p class="error-msg hidden"></p>
                </div>
                <div class="mb-4">
                    <label class="block mb-2 text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Coating Type</label>
                    <input type="text" name="coating_type" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-sm" placeholder="e.g. GA">
                    <p class="error-msg hidden"></p>
                </div>
    ...
    <div class="relative p-4 w-full max-w-md">
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form class="modal-form">
                ...
                <div class="mb-4">
                    <label class="block mb-2 text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Spec Name <span class="text-red-500">*</span></label>
                    <input type="text" name="spec_name" required class="bg-white border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-sm">
                    <p class="error-msg hidden"></p>
                </div>
                <div class="mb-4">
                    <label class="block mb-2 text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Coating Type</label>
                    <input type="text" name="coating_type" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-sm">
                    <p class="error-msg hidden"></p>
                </div>
                <div class="flex gap-4 border-t border-gray-100 pt-4 mt-4">
                    <button type="button" class="close-modal flex-1 px-5 py-2.5 bg-white border border-gray-300 rounded-md text-[10px] font-bold text-gray-700 uppercase tracking-widest hover:bg-gray-50 transition-colors">Cancel</button>
