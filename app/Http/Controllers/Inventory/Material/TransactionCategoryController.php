...
class TransactionCategoryController extends Controller
{
    ...
    {
        return view('inventory.material.master-data.transaction-category');
    }
    ...
    public function destroy($id)
    {
        ...
        $isUsed = \App\Models\InventoryModel\Material\InventoryTransaction::where('transaction_category_id', $transactionCategory->id)->exists();
        if ($isUsed) {
            return response()->json([
                'success' => false,
