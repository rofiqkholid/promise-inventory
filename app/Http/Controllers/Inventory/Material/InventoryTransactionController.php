...
use App\Models\InventoryModel\Material\CoilCenter;
use App\Models\InventoryModel\Material\Supplier;
...
class InventoryTransactionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('inventory.material.inventory_transaction', compact('products', 'categories', 'coilCenters', 'suppliers', 'pics'));
    }
    ...
    public function data(Request $request)
    {
        ...
        if ($request->has('product_detail_id') && !empty($request->product_detail_id)) {
            ...
            if (!is_numeric($prodId)) {
                $decoded = \App\Models\InventoryModel\Material\InventoryProduct::decodeHash($prodId);
        ...
        if ($request->filled('category_id')) {
            ...
            if (!is_numeric($catId)) {
                $decoded = \App\Models\InventoryModel\Material\TransactionCategory::decodeHash($catId);
    ...
    public function store(Request $request)
    {
        ...
        if (isset($data['coil_center_id']) && !is_numeric($data['coil_center_id'])) {
            $data['coil_center_id'] = \App\Models\InventoryModel\Material\CoilCenter::decodeHash($data['coil_center_id']);
        }
        if (isset($data['supplier_id']) && !is_numeric($data['supplier_id'])) {
            $data['supplier_id'] = \App\Models\InventoryModel\Material\Supplier::decodeHash($data['supplier_id']);
        }
        if (isset($data['destination_id']) && !is_numeric($data['destination_id'])) {
            $data['destination_id'] = \App\Models\InventoryModel\Material\Supplier::decodeHash($data['destination_id']);
        }
    ...
    public function edit($id)
    {
        ...
        return response()->json([
            ...
            'coil_center_id' => $transaction->coil_center_id ? \App\Models\InventoryModel\Material\CoilCenter::encodeHash($transaction->coil_center_id) : null,
            'supplier_id' => $transaction->supplier_id ? \App\Models\InventoryModel\Material\Supplier::encodeHash($transaction->supplier_id) : null,
            'destination_id' => $transaction->destination_id ? \App\Models\InventoryModel\Material\Supplier::encodeHash($transaction->destination_id) : null,
        ]);
    }
