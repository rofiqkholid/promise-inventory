...
use App\Models\InventoryModel\Material\Location;
...
class LocationController extends Controller
{
    ...
    {
        return view('inventory.material.master-data.location');
    }
    ...
    public function destroy($id)
    {
        ...
        $isUsed = \App\Models\InventoryModel\Material\StoDetail::where('location_id', $location->id)->exists();
