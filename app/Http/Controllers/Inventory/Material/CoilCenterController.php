...
class CoilCenterController extends Controller
{
    ...
    {
        return view('inventory.material.master-data.coil-center');
    }
    ...
    public function destroy($id)
    {
        ...
        $isUsed = \App\Models\InventoryModel\Material\InventoryTransaction::where('coil_center_id', $coilCenter->id)->exists();
        if ($isUsed) {
            return response()->json([
                'success' => false,
