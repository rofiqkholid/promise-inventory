...
class MaterialSpecController extends Controller
{
    ...
    {
        return view('inventory.material.master-data.material-spec');
    }
    ...
    public function destroy($id)
    {
        ...
        $isUsed = \App\Models\InventoryModel\Material\InventoryProduct::where('material_spec_id', $materialSpec->id)->exists();
        if ($isUsed) {
            return response()->json([
                'success' => false,
