...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $transPcsSql = \App\Models\InventoryModel\Material\InventoryProduct::getPcsCalculationSql('t.qty', 'p', 'u.name');
        $transAmountSql = \App\Models\InventoryModel\Material\InventoryProduct::getAmountCalculationSql('t.qty', 'p', 'u.name');
        ...
        $usageByModel = (clone $queryTrans)
            ...
            ->select(
                ...
                DB::raw("SUM(" . \App\Models\InventoryModel\Material\InventoryProduct::getPcsCalculationSql('t.qty', 'p', 'u.name') . ") as total")
            )
        ...
        $usageByMaker = (clone $queryTrans)
            ...
            ->select('cc.code', DB::raw("SUM(" . \App\Models\InventoryModel\Material\InventoryProduct::getPcsCalculationSql('t.qty', 'p', 'u.name') . ") as total"))
            ->groupBy('cc.code')
            ->get();
        ...
        return view('inventory.material.dashboard', [
            'stats' => $stats,
            'charts' => [
                'stock_grouped' => $stockDataGrouped,
                'usage_model' => $usageByModel,
